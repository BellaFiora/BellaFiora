...
int json_object_setn_new(json_t* object, const char* key, size_t key_len,
						 json_t* value);
int json_object_set_new_nocheck(json_t* object, const char* key, json_t* value);
int json_object_setn_new_nocheck(json_t* object, const char* key,
...
#define json_object_foreach(object, key, value)                                \
	for (key = json_object_iter_key(json_object_iter(object)); key             \
...
static JSON_INLINE int json_object_setn(json_t* object, const char* key,
										size_t key_len, json_t* value) {
...
static JSON_INLINE int json_object_setn_nocheck(json_t* object, const char* key,
												size_t key_len, json_t* value) {
	return json_object_setn_new_nocheck(object, key, key_len,
										json_incref(value));
}
